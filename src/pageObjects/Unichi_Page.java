...
public class Unichi_Page extends BaseClass {
    ...
    public static Select stateList() {
        Select stateList;
        try {
            element = driver.findElement(By.cssSelector("select[ng-model=\"currentUser.address.state\"]"));
            stateList = new Select(element);
    ...
    public static Select countryList() {
        ...
        try {
            ...
            countrylist = new Select(element);
